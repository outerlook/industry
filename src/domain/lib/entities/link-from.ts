...
export const linkFromUnit = getLinkPropsFromIdentifiedObject<
  validTypes['Unit']
>(entityConfig.Unit.toLink)('name');
export const linkFromUser = getLinkPropsFromIdentifiedObject<
  validTypes['User']
>(entityConfig.User.toLink)('name');
