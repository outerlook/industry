import type {Entities, validEntities} from "@services/api/validation/valid-types";
import {getObjectKeywordsFromKeys} from "@services/api/utils/indexable-keys-helper";
import {
